...
#define _1387_TAU_TDR00_VALUE                   (0x1387U)
...
#define _E4E1_TAU_TDR02_VALUE                   (0xE4E1U)
/* Clock divisor for TAU0 channel 2 */
#define _2000_TAU0_CHANNEL2_DIVISOR             (0x2000U)
/* 16-bit timer data register 03 (TDR03) */
#define _0F41_TAU_TDR03_VALUE                   (0x0F41U)
/* Clock divisor for TAU0 channel 3 */
#define _2000_TAU0_CHANNEL3_DIVISOR             (0x2000U)
/* 16-bit timer data register 04 (TDR04) */
#define _752F_TAU_TDR04_VALUE                   (0x752FU)
